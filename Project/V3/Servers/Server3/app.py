...
def setConnection():
    try:
        engine = sqlalchemy.create_engine('mysql://root:my-secret-pw@172.18.0.4')  # connect to server
...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:my-secret-pw@172.18.0.4/expensesdb'
